...
def dialog(text):
    ...
    print(response_json)
    try:
        print('Intent: ',response_json['result']['metadata']['intentName'])
        print('product: ',response_json["result"]['parameters']['product'], ' Quantity: ',response_json["result"]['parameters']['my_number'])
        print('Robot: ',response_json["result"]["fulfillment"]["messages"][0]["speech"])
    except:
        pass
