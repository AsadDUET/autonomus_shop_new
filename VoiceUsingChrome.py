...
def chrome_detect():
    ...
    if (driver.find_element_by_id("gt-speech").get_attribute('aria-label')=="Turn off voice input"):
        print('Speak')#driver.find_element_by_id("gt-speech").get_attribute('aria-label')+'if')
#        print(text2)
        time.sleep(.4)
        if (driver.find_element_by_id("gt-speech").get_attribute('aria-label')=="Turn off voice input"):
        ...
        if(text==text2):
            if(text!=''):
                ...
                time.sleep(.5)
                /html/body/div[2]/div[1]/div[2]/div[2]/div[3]/div[1]/span[1]/span[1]
                /html/body/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[3]/div[1]/div[2]/div/span[1]/span
                
                
    else:
        print(driver.find_element_by_id("gt-speech").get_attribute('aria-label'))
